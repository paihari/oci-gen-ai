...
llm = OCIGenAI(
    ...
    compartment_id="ocid1.compartment.oc1..abcdaaaajgrlbovd6fdokao6ookeun6nfepdwduq66v7bwxidqqwi6jaxgja",
...
docs = retv.get_relevant_documents('Tell us who were Rapporteurs of EU AI intelligence act ')
...
response = chain.invoke("Tell us who were Rapporteurs of EU AI intelligence act, Give me a list of 4")
